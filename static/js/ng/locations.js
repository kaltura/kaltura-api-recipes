...
STATES.AU.push({label: 'Australian Antarctic Territory', value: 'AAT'});
STATES.AU.push({label: 'Australian Capital Territory', value: 'ACT'});
STATES.AU.push({label: 'Northern Territory', value: 'NT'});
STATES.AU.push({label: 'New South Wales', value: 'NSW'});
STATES.AU.push({label: 'Queensland', value: 'QLD'});
STATES.AU.push({label: 'South Australia', value: 'SA'});
STATES.AU.push({label: 'Tasmania', value: 'TAS'});
STATES.AU.push({label: 'Victoria', value: 'VIC'});
...
STATES.UK.push({label: 'Avon', value: 'AVON'});
STATES.UK.push({label: 'Bedfordshire', value: 'BEDS'});
STATES.UK.push({label: 'Berkshire', value: 'BERKS'});
STATES.UK.push({label: 'Buckinghamshire', value: 'BUCKS'});
STATES.UK.push({label: 'Cambridgeshire', value: 'CAMBS'});
STATES.UK.push({label: 'Cheshire', value: 'CHESH'});
STATES.UK.push({label: 'Cleveland', value: 'CLEVE'});
STATES.UK.push({label: 'Cornwall', value: 'CORN'});
STATES.UK.push({label: 'Cumbria', value: 'CUMB'});
STATES.UK.push({label: 'Derbyshire', value: 'DERBY'});
STATES.UK.push({label: 'Devon', value: 'DEVON'});
STATES.UK.push({label: 'Dorset', value: 'DORSET'});
STATES.UK.push({label: 'Durham', value: 'DURHAM'});
STATES.UK.push({label: 'Essex', value: 'ESSEX'});
STATES.UK.push({label: 'Gloucestershire', value: 'GLOUS'});
STATES.UK.push({label: 'Greater London', value: 'GLONDON'});
STATES.UK.push({label: 'Greater Manchester', value: 'GMANCH'});
STATES.UK.push({label: 'Hampshire', value: 'HANTS'});
STATES.UK.push({label: 'Hereford & Worcestershire', value: 'HERWOR'});
STATES.UK.push({label: 'Hertfordshire', value: 'HERTS'});
STATES.UK.push({label: 'Humberside', value: 'HUMBER'});
STATES.UK.push({label: 'Isle of Man', value: 'IOM'});
STATES.UK.push({label: 'Isle of Wight', value: 'IOW'});
STATES.UK.push({label: 'Kent', value: 'KENT'});
STATES.UK.push({label: 'Lancashire', value: 'LANCS'});
STATES.UK.push({label: 'Leicestershire', value: 'LEICS'});
STATES.UK.push({label: 'Lincolnshire', value: 'LINCS'});
STATES.UK.push({label: 'Merseyside', value: 'MERSEY'});
STATES.UK.push({label: 'Norfolk', value: 'NORF'});
STATES.UK.push({label: 'Northamptonshire', value: 'NHANTS'});
STATES.UK.push({label: 'Northumberland', value: 'NTHUMB'});
STATES.UK.push({label: 'Nottinghamshire', value: 'NOTTS'});
STATES.UK.push({label: 'Oxfordshire', value: 'OXON'});
STATES.UK.push({label: 'Shropshire', value: 'SHROPS'});
STATES.UK.push({label: 'Somerset', value: 'SOM'});
STATES.UK.push({label: 'Staffordshire', value: 'STAFFS'});
STATES.UK.push({label: 'Suffolk', value: 'SUFF'});
STATES.UK.push({label: 'Surrey', value: 'SURREY'});
STATES.UK.push({label: 'Sussex', value: 'SUSS'});
STATES.UK.push({label: 'Warwickshire', value: 'WARKS'});
STATES.UK.push({label: 'West Midlands', value: 'WMID'});
STATES.UK.push({label: 'Wiltshire', value: 'WILTS'});
STATES.UK.push({label: 'Yorkshire', value: 'YORK'});
STATES.EI.push({label: 'County Antrim', value: 'CO ANTRIM'});
STATES.EI.push({label: 'County Armagh', value: 'CO ARMAGH'});
STATES.EI.push({label: 'County Down', value: 'CO DOWN'});
STATES.EI.push({label: 'County Fermanagh', value: 'CO FERMANAGH'});
STATES.EI.push({label: 'County Londonderry', value: 'CO DERRY'});
STATES.EI.push({label: 'County Tyrone', value: 'CO TYRONE'});
STATES.EI.push({label: 'County Cavan', value: 'CO CAVAN'});
STATES.EI.push({label: 'County Donegal', value: 'CO DONEGAL'});
STATES.EI.push({label: 'County Monaghan', value: 'CO MONAGHAN'});
STATES.EI.push({label: 'County Dublin', value: 'CO DUBLIN'});
STATES.EI.push({label: 'County Carlow', value: 'CO CARLOW'});
STATES.EI.push({label: 'County Kildare', value: 'CO KILDARE'});
STATES.EI.push({label: 'County Kilkenny', value: 'CO KILKENNY'});
STATES.EI.push({label: 'County Laois', value: 'CO LAOIS'});
STATES.EI.push({label: 'County Longford', value: 'CO LONGFORD'});
STATES.EI.push({label: 'County Louth', value: 'CO LOUTH'});
STATES.EI.push({label: 'County Meath', value: 'CO MEATH'});
STATES.EI.push({label: 'County Offaly', value: 'CO OFFALY'});
STATES.EI.push({label: 'County Westmeath', value: 'CO WESTMEATH'});
STATES.EI.push({label: 'County Wexford', value: 'CO WEXFORD'});
STATES.EI.push({label: 'County Wicklow', value: 'CO WICKLOW'});
STATES.EI.push({label: 'County Galway', value: 'CO GALWAY'});
STATES.EI.push({label: 'County Mayo', value: 'CO MAYO'});
STATES.EI.push({label: 'County Leitrim', value: 'CO LEITRIM'});
STATES.EI.push({label: 'County Roscommon', value: 'CO ROSCOMMON'});
STATES.EI.push({label: 'County Sligo', value: 'CO SLIGO'});
STATES.EI.push({label: 'County Clare', value: 'CO CLARE'});
STATES.EI.push({label: 'County Cork', value: 'CO CORK'});
STATES.EI.push({label: 'County Kerry', value: 'CO KERRY'});
STATES.EI.push({label: 'County Limerick', value: 'CO LIMERICK'});
STATES.EI.push({label: 'County Tipperary', value: 'CO TIPPERARY'});
STATES.EI.push({label: 'County Waterford', value: 'CO WATERFORD'});
