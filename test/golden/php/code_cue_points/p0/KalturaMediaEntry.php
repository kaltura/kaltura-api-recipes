<div class="row" style="margin-bottom: 10px">
  ...
  <div class="col-xs-12 col-md-6 col-md-offset-1">
    <script src="https://cdnapisec.kaltura.com/p/<?php echo $result->partnerId ?>/sp/<?php echo $result->partnerId ?>00/embedIframeJs/uiconf_id/28959921/partner_id/<?php echo $result->partnerId ?>">
    </script>
