<html>
  ...
  <body>
    <div class="container" style="margin-top:40px">
      <div class="KalturaCaptionAssetListResponse"></div>
      <script>
        var element = $('.KalturaCaptionAssetListResponse').last();
        element[0].loadData = function() {
          $('.KalturaCaptionAssetListResponse').last().load('listCaptionAsset.php');
        }
        element[0].loadData();
      </script>
